...
- If you are in an isolated worktree. Try finding the associated .git file in the top most folder within that worktree, as claude will be run in a sub-directory
